-- واجهة بسيطة لتشغيل سكربت c00lgui
...
main.BackgroundColor3 = Color3.new(0, 0, 0) -- أسود
main.BorderSizePixel = 2
main.BorderColor3 = Color3.new(1, 0, 0) -- أحمر
main.Active = true
main.Draggable = true
main.Parent = gui
...
title.Text = "c00luck"
title.TextColor3 = Color3.new(1, 0, 0) -- أحمر
