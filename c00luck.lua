...
main.BackgroundColor3 = Color3.new(0, 0, 0) -- Black
main.BorderColor3 = Color3.new(1, 0, 0) -- Red
main.BorderSizePixel = 3
main.Active = true    -- Enables dragging
main.Draggable = true -- Allows dragging
main.Parent = gui
...
button.Position = UDim2.new(0.1, 0, 0, 350)
...
button.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/supermarioglitc/c00lgui-reborn-v1.1-by-007n7/main/c00lgui%20script.txt"))()
end)
